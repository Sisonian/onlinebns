				...
				<div class="col-md-3">
				  <div class="box-info-product" style="box-shadow: 1px 1px 20px gray">
					<center><?php echo "<p class='price2'>&#8369; $item_price</p>";?>
							<a href="user_update.php?item_id=<?php echo"$item_id"; ?>" style="text-decoration: none;">
							<button type="submit" name="Submit" style="border:none; outline: none; position: relative; display: block; background:#e67e22;">
							   <span style="	font-weight: 700; font-size: 20px; line-height: 22px; padding: 13px 40px 13px 40px; color: #FFF;display: block !important;">Update</span></button></a>
							<br>
							<a href="user_delete.php?item_id=<?php echo"$item_id"; ?>&&account_id=<?php echo "$seller_id"; ?>" style="text-decoration: none;">
							<button type="submit" name="Submit" style="border:none; outline: none; position: relative; display: block; background:#e74c3c;">
							   <span style="	font-weight: 700; font-size: 20px; line-height: 22px; padding: 13px 40px 13px 40px; color: #FFF;display: block !important;">Remove</span>
							</button></center></a>
				   </div><br>
				   <div class="box-info-product" style="box-shadow: 1px 1px 20px gray">
