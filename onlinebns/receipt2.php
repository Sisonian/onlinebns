...
$seller_id_sql="SELECT account_email FROM account where account_id='".$seller_id."'";
$seller_id_result=mysqli_query($connect,$seller_id_sql);
$seller_id_fetch=mysqli_fetch_array($seller_id_result);
$paypal_url='https://www.sandbox.paypal.com/cgi-bin/webscr'; 
$paypal_id=$seller_id_fetch[0];  // sriniv_1293527277_biz@inbox.com
...
$seller_sql1=mysqli_query($connect,"SELECT buyer_email FROM transaction where seller_email='".$paypal_id."' and item_id = '".$product_id."'");
$seller_fetch1 = mysqli_fetch_array($seller_sql1);
$buyer = $seller_fetch1[0];
