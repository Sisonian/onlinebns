  ...
  if($_POST['action']=="send")
    {
        ...
        $addaccount="INSERT INTO chat (sender_email,sender_name,sender_image,sender_message,receiver_email,receiver_name,receiver_image,chat_time,subject_id,subject_name,chat_subject) VALUES ('$account_email2','$account_fname2 $account_lname2','$account_image2','$message','$account_email','$account_fname $account_lname','$account_image',NOW(),'$subject','$subject_name','$chat_subject')";
          ...
          $redirecttoprevpage = "chat.php?account_id=$id && chat_subject=$subject && chat_subject_name=$subject_name";
...
<body id="chat-scroll">
<div class="menu">
            <a href="viewitem.php?item_id=<?php echo"$subject"; ?>" class="back"><i class=""></i><img src="images/<?php echo "$account_image"; ?>" draggable="false"/></a>
...
<div class="typezone">
<form action="" method="post" enctype="multipart/form-data"><input type="text" name="message" placeholder="Say something" autocomplete="off"><input name="action" type="hidden" value="send" required /><input type="submit" class="send" name="send" value=""/></form></div>
