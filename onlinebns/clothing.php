...
<body>
	...
	<div id="mySidenav" class="sidenav">
     ...
     <div class="main">
     	<div style="text-align: center; background: #F2F2F2; padding-top:18px;"><h1>Clothing</h1><br></div>
      <div class=""><!--    former name:   <div class="shop_top"> -->
		<div class="container">
			<div class="row shop_box-top">
			<?php
		$db=mysqli_connect("localhost","root","","buy");
		$sql="SELECT * FROM items where item_category='clothing' and approved_to_post='Approved'";
