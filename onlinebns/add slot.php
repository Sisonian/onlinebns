  ...
  <div id="invoice" class="effect2">
    ...
    <div id="invoice-mid">
      ...
      <div id="project">
        ...
        <p><?php 
        echo "<b>Purchase Details: </b> add 20 post slots  <br><br>";
        echo "<b>Purchase Name: </b> $product_name <br><br>";
        echo "<b>Purchase Price: </b> ₱ $product_price";
      ...
      <div id="table">
        <table>
          ...
          <tr class="service">
            ...
            <td class="tableitem"><p class="itemtext"><?php echo date('M-d-Y'); ?></p></td>
    ...
    <form>
      <a href="pay_slot.php?product_name=<?php echo $product_name; ?>&product_price= <?php echo $product_price; ?>&seller_email=<?php echo $paypal_id; ?>"><img src="images/paypal.png" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!"></a>
    </form>
