...
<body>
	...
	<div id="mySidenav" class="sidenav">
     ...
     <div class="main" style="padding: 20px; width: 100%; height: 125px; border: 1px; background:#F2F2F2;"><div style="float: left;"><img src=<?php echo"'images/".$account_image."'"?> style="width: 80px;-webkit-border-radius: 50%;-moz-border-radius: 50%;-ms-border-radius: 50%;border-radius: 50%;">&nbsp;&nbsp;<?php echo "$account_email";?></div><div style="float: right; padding: 25px; padding-right: 30px;"><ul><a href="userpage.php?account_id=<?php echo "$account_id" ?>"><li class="active">Manage Ads</li></a>&emsp;<a href="sellitems.php?account_id=<?php echo "$id";?>"><li>Sell your Items</li></a>&emsp;<a href="chatpage.php?account_id=<?php echo"$id";?>"><li>Chats&emsp;<span class="badge count"></span></li></a>&emsp;<a href="logout.php"><li>Logout</li></a></ul></div></div><br>
     	<h1 style="float: left;">Manage Ads / History:</h1>
     			<select class="type" id="service" onChange="see();" name="service" style="float: right;outline-color:#00BFF0;font-size: 1em;padding: 0.5em;font-family: 'Open Sans', sans-serif;width: 200px;height: 55px;margin-right: 20px;" required>
	                 <option value='' disabled>--Choose View Type--</option>
	                 <option value='Posted' selected>Posted Items</option>
      ...
      <div class="shop_top">
		<div class="container">
		  <div class="row shop_box-top" id="posted">
			<?php
			$db=mysqli_connect("localhost","root","","buy");
			$sql="SELECT * FROM items where seller_name='$account_fname $account_lname' and approved_to_post != 'Sold'";
			...
			else
			{
				while ($row=mysqli_fetch_array($result)) 
				{
					...
					$item_image=$photorow[1];
						...
						echo "<br>";
						echo "<a href='user_view_item.php?item_id=$id' class='shop_image'>";
						echo "<figure>
	...
	?>							
			...
			<div class="row shop_box-top" id="sold" style="display: none;">
			<?php
			$db=mysqli_connect("localhost","root","","buy");
			$sql="SELECT * FROM items where seller_name='$account_fname $account_lname' and approved_to_post = 'Sold'";
			$result=mysqli_query($db,$sql);
			...
			else
			{
				while ($row=mysqli_fetch_array($result)) 
				{
					...
					$item_image=$photorow[1];
						echo "<div class='col-md-3 shop_box'><a href='single.html'>";
						echo "<br>";
						echo "<a href='user_sold_items.php?item_id=$id' class='shop_image'>";
						echo "<figure>
												<img src='images/item_images/".$item_image."'' alt='Image' class='img-responsive'>
										  </figure> </a>";
						echo "<div class='shop_desc'>";
