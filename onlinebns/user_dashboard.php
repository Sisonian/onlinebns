...
<body>
	...
	<div id="mySidenav" class="sidenav">
     ...
     <div class="main" style="padding: 20px; width: 100%; height: 125px; border: 1px; background:#F2F2F2;"><div style="float: left;"><img src=<?php echo"'images/".$account_image."'"?> style="width: 80px;-webkit-border-radius: 50%;-moz-border-radius: 50%;-ms-border-radius: 50%;border-radius: 50%;">&nbsp;&nbsp;<?php echo "$account_email";?></div><div style="float: right; padding: 25px; padding-right: 30px;"><ul><a href="userpage.php?account_id=<?php echo "$account_id" ?>"><li>Manage Ads</li></a>&emsp;<a href="user_dashboard.php?account_id=<?php echo "$id";?>"><li class="active">User Dashboard</li></a>&emsp;<a href="sellitems.php?account_id=<?php echo "$id";?>"><li>Sell your Items</li></a>&emsp;<a href="chatpage.php?account_id=<?php echo"$id";?>"><li>Chats&emsp;<span class="badge count"></span></li></a>&emsp;<a href="logout.php"><li>Logout</li></a></ul></div></div><br>
     	 <div class="market-updates">
			<div class="col-md-4 market-update-gd">
				<div class="market-update-block clr-block-1">
					<div class="col-md-8 market-update-left">
					<?php 
						$registered_user_query="SELECT COUNT(approved_to_post) FROM items WHERE approved_to_post='Approved' and seller_id = $id";
			...
			<div class="col-md-4 market-update-gd">
				<div class="market-update-block clr-block-2">
				 <div class="col-md-8 market-update-left">
				 <?php
						$pending_posts_query="SELECT COUNT(approved_to_post) FROM items WHERE approved_to_post='Sold' and seller_id = $id";
		...
		<center><div style="width: 100%;padding-left: 1.5%;padding-right: 1.5%;" id="printableArea">
                 <div class="row">
                        <div style="width: 49%;float: left;margin-left: 10px;margin-right: 3px;">
                              ...
                              <div class="card z-depth-3" style="    border-radius: 10px;">
                                    <center><div style="color: white; background: rgba(52, 73, 94,1.0); height: 50px; padding: 10px;     border-top-left-radius: 10px;     border-top-right-radius: 10px;">
                                          <h5 class="" style=" font-size: 20px; margin:10px; font-family: 'Raleway',sans-serif;">Your Active and Sold Items</h5>
                                    </div></center>
                                    <div class="card-content">
                                          <div class="chart-container">
                                          		<div style="float: left;">User<br>Rating</div>
                                                <canvas id="mycanvas8" width="600" height="350"></canvas>
                        ...
                        <div style="width: 49%;float: left;margin-left: 3px;margin-right: 10px;">
                              ...
                              <div class="card z-depth-3" style="  border-radius: 10px;">
                                    <center><div style="color: white; background: rgba(52, 73, 94,1.0); height: 50px; padding: 10px;    border-top-left-radius: 10px;     border-top-right-radius: 10px;">
                                          <b><h5 class="" style=" font-size: 20px;  margin:10px;font-family: 'Raleway',sans-serif;">Your Number of Items per Category</h5></b>
                                    </div></center>
                                    <div class="card-content">
                                          <div class="chart-container">
...
$(document).ready(function(){
 ...
 setInterval(function(){ 
  load_unseen_notification();; 
      ...
      <script type="text/javascript" src="js/get_studentdata8.js"></script>
      <script type="text/javascript" src="js/initialize.js"></script>
      <script type="text/javascript" src="js/navbar.js"></script>